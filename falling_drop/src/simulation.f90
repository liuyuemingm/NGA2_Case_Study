	...
	subroutine simulation_init
	   ...
	   create_and_initialize_vof: block
         ...
         call vf%initialize(cfg=cfg,reconstruction_method=lvira,name='VOF',store_detailed_flux=.true.)
		   ...
		   center=[0.01707_WP,0.00707_WP,0.0_WP]
		   radius=0.002_WP
		   depth =0.02_WP
				...
				do j=vf%cfg%jmino_,vf%cfg%jmaxo_
					do i=vf%cfg%imino_,vf%cfg%imaxo_
				      ...
				      vol=0.0_WP; area=0.0_WP; v_cent=0.0_WP; a_cent=0.0_WP
						call cube_refine_vol(cube_vertex,vol,area,v_cent,a_cent,levelset_falling_drop,0.0_WP,amr_ref_lvl) ! integrate
						vf%VF(i,j,k)=vol/vf%cfg%vol(i,j,k) ! liquid volumn fraction
